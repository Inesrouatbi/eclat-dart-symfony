...
class OeuvresController extends AbstractController
{
    ...
    public function index(OeuvresRepository $oeuvresRepository): Response
    {
        ...
        $nombreRec = $oeuvresRepository->countTotalOeuvres();

        $nbTypeRec = $oeuvresRepository->countOeuvresByType("Peinture");
        $nbTypeDi = $oeuvresRepository->countOeuvresByType("Sculpture");
        $nbTypeDe = $oeuvresRepository->countOeuvresByType("Gravure");
        $nbTypeRem = $oeuvresRepository->countOeuvresByType("Céramique");


        $moyTypeRec = $oeuvresRepository->averageOeuvreByType("Peinture");
        $moyTypeDi = $oeuvresRepository->averageOeuvreByType("Sculpture");
        $moyTypeDe = $oeuvresRepository->averageOeuvreByType("Gravure");
        $moyTypeRem = $oeuvresRepository->averageOeuvreByType("Céramique");
